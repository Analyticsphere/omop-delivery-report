...
# Data Aggregators
# ==============================================================================
# Core business logic for aggregating and combining data across tables and groups.
# These functions prepare structured data for report generation.
...
#' @return Named list of table data structures
#' @export
...
#' Prepare complete report data with all calculations
#'
#' Performs all business logic calculations needed for the report.
#' Aggregates data by groups, calculates statistics, and prepares
#' structured data for JSON serialization.
#'
#' This is the main orchestrator function that combines data from multiple
#' sources into a complete report data structure.
#'
#' @param metrics List of metric data frames from parse_delivery_metrics()
